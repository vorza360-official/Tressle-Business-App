    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Container(
          ...
          child: CircleAvatar(
            radius: 30,
            backgroundImage: AssetImage('assets/images/dummy_image_map.png'),
          ),
        ),
        actions: [
          IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Text("Booking List", style: TextStyle(fontSize: 26)),
                Spacer(),
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BookingListScreenH(),
                      ),
                    );
                  },
                  child: Text(
              ...
              child: isLoading
                  ...
                  : StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        var activeBookings = snapshot.data!.docs.where((doc) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            var appointment = activeBookings[index];
