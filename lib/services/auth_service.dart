...
class AuthService {
  ...
  String _generateShopId() {
    return _firestore.collection('shops').doc().id;
  }
  ...
  Future<Map<String, dynamic>> signInWithGoogle() async {
    try {
      ...
      if (userDoc.exists) {
        ...
        // New user - create Firestore document with userType and shopId
        final userData = {
          'uid': user.uid,
          'email': user.email,
          ...
          'countryName': '',
          'authProvider': 'google',
          'profileComplete': false, // Needs additional info
          'userType': 'business', // Default user type
          'shopId': _generateShopId(), // Auto-generated shop ID
  ...
  Future<Map<String, dynamic>> createUserWithEmail({
    ...
    try {
      ...
      // Store user data in Firestore with userType and shopId
